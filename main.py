...
class IranNewsRadar:
    ...
    def batch_analyze_with_gemini(self, candidates_data):
        ...
        system_prompt = (
            ...
            " - از کلمات قلم‌به‌سلم، پیچیده و عجیب دانشگاهی (مثل: 'گره مشخص'، 'تعمیم روایت'، 'شکل‌گیری محاسبات') مطلقاً استفاده نکن و یادت باشه هر موضوعی که باعث میشه باعث مسدودی کانال بله بشه جلوگیری کن و کلمات حساس مخالف رژیم جمهوری اسلامی رو با سانسور حرف به حرف سانسور کن.\n"
